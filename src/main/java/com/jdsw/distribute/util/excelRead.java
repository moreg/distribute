...
public class excelRead {
    //日志输出
   // private static final Logger logger = (Logger) LoggerFactory.getLogger(excelRead.class);
    //定义excel类型
...
/**==============================================================================================================================**/
    ...
    public static void main(String[] args)throws Exception{
         ...
         */
        List<Map<String,Object>> result =excelRead.ReadExcelByRC("E:\\高级搜索导出数据.xlsx",0,-1,false);
         ...
         * Class<T>：传过来的实体类类型
         */
       /* List<Object> result2 = excelRead.ReadExcelByPOJO("D:.xls",2,10, Excel.class);
